        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              marginBottom: '2rem',
              padding: '1rem',
              background: 'rgba(245, 158, 11, 0.1)', // var(--warn) with opacity
              ...
              <div dangerouslySetInnerHTML={{
                __html: DOMPurify.sanitize(marked.parse(`## Important Notice
> **This document has been generated by Clarynt Documentation Assistant, an AI-powered chatbot. While it provides guidance on the Colorado AI Act and helps draft compliance documentation, it does NOT offer legal advice. For any legal matters, please consult qualified legal counsel before making decisions based on this content.**`))
              }} />
            </div>
